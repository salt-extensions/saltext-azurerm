...
def default_security_rule_get(name, security_group, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.default_security_rule_get DenyAllOutBound testnsg testgroup
...
def default_security_rules_list(security_group, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.default_security_rules_list testnsg testgroup
...
def security_rule_create_or_update(
    ...
    **kwargs,
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.security_rule_create_or_update testrule1 allow outbound 101 tcp testnsg testgroup \
...
def security_rule_delete(security_rule, security_group, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.security_rule_delete testrule1 testnsg testgroup
...
def network_security_group_create_or_update(
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_security_group_create_or_update testnsg testgroup
...
def network_security_group_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_security_group_delete testnsg testgroup
...
def network_security_groups_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_security_groups_list testgroup
...
def network_security_groups_list_all(**kwargs):  # pylint: disable=invalid-name
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_security_groups_list_all
...
def subnets_list(virtual_network, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.subnets_list testnet testgroup
...
def subnet_create_or_update(name, address_prefix, virtual_network, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.subnet_create_or_update testsubnet \
    ...
    if kwargs.get("network_security_group"):
        nsg = network_security_group_get(
            name=kwargs["network_security_group"], resource_group=resource_group, **kwargs
        )
        if "error" not in nsg:
...
def subnet_delete(name, virtual_network, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.subnet_delete testsubnet testnet testgroup
...
def virtual_networks_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.virtual_networks_list_all
...
def virtual_networks_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.virtual_networks_list testgroup
...
def virtual_network_create_or_update(name, address_prefixes, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.virtual_network_create_or_update \
...
def virtual_network_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.virtual_network_delete testnet testgroup
...
def load_balancers_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.load_balancers_list_all
...
def load_balancers_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.load_balancers_list testgroup
...
def load_balancer_create_or_update(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.load_balancer_create_or_update testlb testgroup
                ...
                if "error" not in vnets:
                    for vnet in vnets:
                        subnets = subnets_list(
                            virtual_network=vnet, resource_group=resource_group, **kwargs
                        )
                        if kwargs["frontend_ip_configurations"][idx]["subnet"] in subnets:
                            kwargs["frontend_ip_configurations"][idx]["subnet"] = {
                                "id": str(
                                    subnets[kwargs["frontend_ip_configurations"][idx]["subnet"]][
                                        "id"
                                    ]
                                )
                            }
...
def load_balancer_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.load_balancer_delete testlb testgroup
...
def network_interface_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_interface_delete test-iface0 testgroup
...
def network_interface_create_or_update(
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_interface_create_or_update test-iface0 [{'name': 'testipconfig1'}] \
    ...
    if isinstance(ip_configurations, list):
        subnet = subnet_get(
            name=subnet, virtual_network=virtual_network, resource_group=resource_group, **kwargs
        )
...
def network_interfaces_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_interfaces_list_all
...
def network_interfaces_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.network_interfaces_list testgroup
...
def list_virtual_machine_scale_set_vm_network_interfaces(
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.list_virtual_machine_scale_set_vm_network_interfaces testset testvm testgroup
...
def list_virtual_machine_scale_set_network_interfaces(scale_set, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.list_virtual_machine_scale_set_vm_network_interfaces testset testgroup
...
def get_virtual_machine_scale_set_network_interface(
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.get_virtual_machine_scale_set_network_interface test-iface0 testset testvm testgroup
...
def public_ip_address_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.public_ip_address_delete test-pub-ip testgroup
...
def public_ip_address_get(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.public_ip_address_get test-pub-ip testgroup
...
def public_ip_address_create_or_update(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.public_ip_address_create_or_update test-ip-0 testgroup
...
def public_ip_addresses_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.public_ip_addresses_list_all
...
def public_ip_addresses_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.public_ip_addresses_list testgroup
...
def route_filter_rule_delete(name, route_filter, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_rule_delete test-rule test-filter testgroup
...
def route_filter_rule_get(name, route_filter, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_rule_get test-rule test-filter testgroup
...
def route_filter_rule_create_or_update(
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_rule_create_or_update \
...
def route_filter_rules_list(route_filter, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_rules_list test-filter testgroup
...
def route_filter_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_delete test-filter testgroup
...
def route_filter_get(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_get test-filter testgroup
...
def route_filter_create_or_update(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filter_create_or_update test-filter testgroup
...
def route_filters_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filters_list testgroup
...
def route_filters_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_filters_list_all
...
def route_delete(name, route_table, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_delete test-rt test-rt-table testgroup
...
def route_get(name, route_table, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_get test-rt test-rt-table testgroup
...
def routes_list(route_table, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.routes_list test-rt-table testgroup
...
def route_table_delete(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_table_delete test-rt-table testgroup
...
def route_table_get(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_table_get test-rt-table testgroup
...
def route_table_create_or_update(name, resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_table_create_or_update test-rt-table testgroup
...
def route_tables_list(resource_group, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_tables_list testgroup
...
def route_tables_list_all(**kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call azurerm_network.route_tables_list_all
